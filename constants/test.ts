[
    ...
    { mal_id: 5, name: "Avant Garde" }, //d
    { mal_id: 46, name: "Award Winning" },
    { mal_id: 28, name: "Boys Love" }, //d
    { mal_id: 4, name: "Comedy" },
    { mal_id: 8, name: "Drama" },
    { mal_id: 10, name: "Fantasy" },
    { mal_id: 26, name: "Girls Love" }, //d
    { mal_id: 47, name: "Gourmet" }, //d
    ...
    { mal_id: 9, name: "Ecchi" }, //d
    { mal_id: 51, name: "Anthropomorphic" }, //d
    { mal_id: 52, name: "CGDCT" }, //d
    { mal_id: 54, name: "Combat Sports" }, //d
    { mal_id: 55, name: "Delinquents" }, //d
    { mal_id: 39, name: "Detective" },
    { mal_id: 56, name: "Educational" }, //d
